...
const STATUS_ALIAS: Record<string, (typeof PIPELINE)[number]> = {
  ...
  PAID: 'DEPOSIT_PAID',
  WAITLIST: 'APPROVED',
  LOTTERY_WON: 'APPROVED',
  LOTTERY_PENDING: 'APPROVED',
  LOTTERY_WAITING: 'APPROVED',
  LOTTERY_IN_PROGRESS: 'APPROVED',
  CANCELLATION_REQUESTED: 'DEPOSIT_PAID',
  INSTALLMENT_IN_PROGRESS: 'DEPOSIT_PAID',
