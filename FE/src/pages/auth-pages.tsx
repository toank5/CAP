...
export function RegisterPage() {
  ...
  return (
    <Card className="mx-auto w-full max-w-md">
      <CardHeader><CardTitle>Đăng ký tài khoản</CardTitle><CardDescription>Tạo tài khoản RHS mới</CardDescription></CardHeader>
      <CardContent>
        <form onSubmit={submit} className="space-y-4">
          ...
          <FormField label="Vai trò" htmlFor="role">
            <Select id="role" name="role" defaultValue="Applicant">
  ...
  return (
    <Card className="mx-auto w-full max-w-md">
      ...
      <CardContent>
        ...
        <AuthLinks prompt="" link="Đặt lại mật khẩu" route="reset-password" />
      </CardContent>
    </Card>
  )
}
